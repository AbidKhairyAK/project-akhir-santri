		...
		<div id="container" class="admin form clearfix">
			...
			<div id="main" class="clearfix">
				...
				<div class="content clearfix">
					...
					<form id="form" action="proses/proses_author_add.php" method="post">
						<table>
							<tr>
								<td><label for="name">Name</label></td>
								<td><input type="text" name="name" id="name" class="" maxlength="100" required></td>
							</tr>
							<tr>
								<td><label for="email">Email</label></td>
								<td><input type="email" name="email" id="email" class="" maxlength="100" required></td>
							</tr>
							<tr>
								<td><label for="pass">Password</label></td>
								<td><input type="password" name="pass" id="pass" class="" minlength="5" maxlength="20" required></td>
							</tr>
							<tr>
								<td></td>
