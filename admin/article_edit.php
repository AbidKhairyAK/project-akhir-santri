					...
					<form id="form" action="proses/proses_article_edit.php" method="post" enctype="multipart/form-data">
						...
						<table>
							<tr>
								...
								<td><input type="text" name="title" id="title" maxlength="255" class="" value="<?= $row['article_title'] ?>" required></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><textarea type="text" name="content" id="content" class="" required> <?= $row['article_content'] ?></textarea></td>
							</tr>
							<tr>
								<td><label for="quote">Quote<br></label></td>
								<td><input type="text" name="quote" id="quote" value="<?= $row['article_quote'] ?>"><span class="ex">(Optional)</span></td>
							</tr>
							<tr>
								<td><label for="tags">Tags</label></td>
								<td><input type="text" name="tags" id="tags" value="<?= $row['article_tags'] ?>" class=""><span class="ex">(Optional, Separate with comma)</span></td>
							</tr>
							<tr>
								<td><label for="image">Image<br></label></td>
								<td>
									<label id="img">
										<p>Choose file</p>
