			...
			<div id="main" class="clearfix">
				...
				<div class="content clearfix">
					...
					<form id="form" action="proses/proses_comment_edit.php" method="post">
						...
						<table>
							<tr>
								<td><label for="article">Article Title</label></td>
							...
							<tr>
								...
								<td><textarea type="text" name="content" id="content" disabled><?= $row['comment_content'] ?></textarea></td>
							</tr>
							<tr>
								<td><label for="reply">Reply</label></td>
								<td><textarea type="text" name="reply" id="content2" disabled><?= comment($row['comment_reply']) ?></textarea></td>
							</tr>
						</table>
					</form>
				</div>
